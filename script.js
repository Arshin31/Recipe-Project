async function getdata() {
    try {
     let item = name;
     let resultname = name;   
     let recipeurl = await fetch('https://api.edamam.com/search?q=' + item + '&app_id=2b2c74b6&app_key=c142ddf9674d7714f04bcd3713142cba')
     let recipedata = await recipeurl.json()
     builddata(recipedata);
     // console.log(recipedata);
     let result = document.getElementById('result');
     result.innerHTML = "Recipe For :" + resultname
 ...
 async function getdata2() {
     ...
     //  console.log(recipedata);
      let result = document.getElementById('result');
      result.innerHTML = "Recipe For :" + item
